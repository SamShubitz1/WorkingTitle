...
var abilities: Dictionary = {
	...
	"Trample": {"name": "Trample", "ability_type": AbilityType.ATTACK, "damage": { "type": DamageType.PHYSICAL, "value": 75}, "action_cost": 3, "energy_cost": 0, "target_type": TargetType.ENEMY, "attribute_bonus": Attributes.STRENGTH, "description": "+75 physical damage. If a move action was made, +25 damage.", "range": Vector2i(3,1), "shape": AbilityShape.MELEE, "sound": "res://Scenes/Battle/Animations/Animation_Sounds/Beam_Slice.wav", "effects": [], "animation": {"name": "Trample", "origin": AnimOrigin.OTHER, "duration": 0.8}},
	
	"Charge Beam": {"name": "Charge Beam", "ability_type": AbilityType.ATTACK, "damage": { "type": DamageType.ENERGY, "value": 75}, "action_cost": 3, "energy_cost": 8, "target_type": TargetType.ENEMY, "attribute_bonus": Attributes.FLUX, "description": "+75 energy damage. If an aim action was made, +25 damage.", "range": Vector2i(7,0), "shape": AbilityShape.SINGLE, "sound": "res://Scenes/Battle/Animations/Animation_Sounds/Beam_Slice.wav", "effects": [], "animation": {"name": "ChargeBeam", "origin": AnimOrigin.OTHER, "duration": 0.8}},
