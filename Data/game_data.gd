...
var abilities: Dictionary = {"Rock" : {"name": "Rock", "type": "Rock", "damage": 20, "description": "A rock based attack", "range": 2, "target": "enemy"}, "Paper": {"name": "Paper", "type": "Paper", "damage": 20, "description": "A paper based attack", "range": 2, "target": "enemy"}, "Scissors": {"name": "Scissors", "type": "Scissors", "damage": 20, "description": "A scissors based attack", "range": 2, "target": "enemy"}}
